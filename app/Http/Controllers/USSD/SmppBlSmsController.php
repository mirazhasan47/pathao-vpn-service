...
class SmppBlSmsController extends Controller
{
  ...
  //////////////////////////////////////////////////
	public function open($host,$port,$system_id,$password) {
  ...
  //////////////////////////////////////////////////
public function submit_sm($source_addr,$destintation_addr,$short_message,$optional='') {
